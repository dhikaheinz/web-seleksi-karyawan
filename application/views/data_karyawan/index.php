                                  ...
                                  <li>
                                      <div class="dropdown inline">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="<?= base_url('Karyawan/pdf'); ?>">PDF</a>
                                              <a class="dropdown-item" href="<?= base_url('Karyawan/excel'); ?>">EXEL</a>
                                          </div>
                                      </div>
                                  </li>
                              </ul>
                                  ...
                                  <tbody>
                                      ...
                                      <?php foreach ($data_karyawan as $c) : ?>
                                          <tr>
                                              ...
                                              <td><?= $c['nilai_test'] ?></td>
                                              <td>
                                                  <a href="<?= base_url('karyawan/edit/') . $c['id_karyawan']; ?>" onclick="return confirm('Edit Data Calon Karyawan? (Akan Menghapus Proses Fuzzy Juga!)');" class="badge badge-warning" style="font-size: 13px;">EDIT</a>
                                                  <a href="<?= base_url('karyawan/hapus/') . $c['id_karyawan']; ?>" onclick="return confirm('Hapus Data Calon Karyawan? (Akan Menghapus Proses Fuzzy Juga!)');" class="badge badge-danger" style="font-size: 13px;">HAPUS</a>
                                              </td>
                                          </tr>
                                      <?php endforeach; ?>
                                  </tbody>
